...
Virtual Resources
-----------------
Virtual resources are not represented by concrete mongodb documents. Instead they are generated by acting on existing mongodb documents, typically via the mongodb `aggregate` pipeline.
