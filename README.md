...
Virtual Resources
-----------------
A virtual resource is not represented by concrete mongodb document. Instead they are generated by acting on existing mongodb documents, typically via the mongodb `aggregate` pipeline.
