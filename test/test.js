...
describe('Connect to MongoDB', () => {
  ...
  it('Drop test database', () => {
    return mongoose.connection.db.dropDatabase();
  });

  it('Should connect MongoDB without mongoose', () => {
...
describe('Test single resource CRUD capabilities', () => {
  ...
  it('/PUT Change data on the resource', () => {
    return request(app)
  ...
  it('/PATCH Change data on the resource', () => {
    return request(app)
  ...
  it('/PATCH Reject update due to failed test op', () => {
    return request(app)
      .patch(`/test/resource1/${resource._id}`)
      .send([
  ...
  it('Cannot /POST to an existing resource', () => {
    return request(app)
...
function testSearch(testPath) {
  ...
  it('Should ignore empty populate query parameter', () => {
    return request(app)
  ...
  it('Should not populate paths that are not a reference', () => {
    return request(app)
  ...
  it('Should accept a change in limit', () => {
    return request(app)
  ...
  it('Should be able to skip and limit', () => {
    return request(app)
  ...
  it('Should default negative limit to 10', () => {
    return request(app)
      .get(`${testPath}?limit=-5&skip=4`)
      .expect('Content-Type', /json/)
  ...
  it('Should default negative skip to 0', () => {
    return request(app)
      .get(`${testPath}?limit=5&skip=-4`)
      .expect('Content-Type', /json/)
      .expect('Content-Range', '0-4/26')
  ...
  it('Should default negative skip and negative limit to 0 and 10', () => {
    return request(app)
      .get(`${testPath}?limit=-5&skip=-4`)
      .expect('Content-Type', /json/)
  ...
  it('Should default non numeric limit to 10', () => {
    return request(app)
  ...
  it('Should default non numeric skip to 0', () => {
    return request(app)
  ...
  it('Should paginate with a sort', () => {
    return request(app)
  ...
  it('equals (alternative) search selector', () => {
    return request(app)
      .get(`${testPath}?age=5`)
      .expect('Content-Type', /json/)
      .expect(200)
  ...
  it('exists=false search selector', () => {
    return request(app)
  ...
  it('exists=true search selector', () => {
    return request(app)
...
describe('Test single resource search capabilities', () => {
  ...
  it('Create a full index of resources', () => {
    return _.range(25).reduce((promise, age) => {
...
describe('Test single resource handlers capabilities', () => {
  ...
  it('A POST request should invoke the global handlers', () => {
    return request(app)
      .post('/test/resource2')
      .send({
        title: 'Test1',
  ...
  it('A GET request should invoke the global handlers', () => {
    return request(app)
  ...
  it('A PUT request should invoke the global handlers', () => {
    return request(app)
  ...
  it('A GET (Index) request should invoke the global handlers', () => {
    return request(app)
      .get('/test/resource2')
      .expect('Content-Type', /json/)
      .expect(200)
  ...
  it('A DELETE request should invoke the global handlers', () => {
    return request(app)
...
describe('Test nested resource CRUD capabilities', () => {
  ...
  it('/GET an empty list of nested resources', () => {
    return request(app)
  ...
  it('/GET the list of nested resources', () => {
    return request(app)
  ...
  it('/PATCH data on the nested resource', () => {
    return request(app)
  ...
  it('/PATCH rejection on the nested resource due to failed test op', () => {
    return request(app)
      .patch(`/test/resource1/${resource._id}/nested1/${nested._id}`)
      .send([
        { 'op': 'test', 'path': '/title', 'value': 'not-the-title' },
  ...
  it('/GET the nested resource with patch changes', () => {
    return request(app)
      .get(`/test/resource1/${resource._id}/nested1/${nested._id}`)
      .expect('Content-Type', /json/)
      .expect(200)
  ...
  it('/GET index of nested resources', () => {
    return request(app)
      .get(`/test/resource1/${resource._id}/nested1`)
      .expect('Content-Type', /json/)
      .expect(200)
  ...
  it('Cannot /POST to an existing nested resource', () => {
    return request(app)
...
describe('Test nested resource handlers capabilities', () => {
  ...
  it('A POST request to a child resource should invoke the global handlers', () => {
    return request(app)
  ...
  it('A GET request to a child resource should invoke the global handlers', () => {
    return request(app)
  ...
  it('A PUT request to a child resource should invoke the global handlers', () => {
    return request(app)
  ...
  it('A GET (Index) request to a child resource should invoke the global handlers', () => {
    return request(app)
  ...
  it('A DELETE request to a child resource should invoke the global handlers', () => {
    return request(app)
...
describe('Test before hooks', () => {
  ...
  describe('get hooks', () => {
    ...
    it('Call hooks are called in order', () => {
      return request(app)
        .get(`/hook/${sub._id}`)
        .expect('Content-Type', /json/)
        .expect(200)
